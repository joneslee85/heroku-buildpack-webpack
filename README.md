...
The `bin/compile` script run webpack with the default configuration file (`webpack.production.config.js` in your main directory). To use the buildpack:
...
2. Configure your `.buildpacks` file:
   ...
   https://github.com/joneslee85/heroku-buildpack-webpack
   ```
